# From https://github.com/j2kun/mlir-tutorial/pull/1/files
workspace(name = "mlir_optimization_pass_example")
...
new_local_repository(
    name = "isl",
    build_file = "@//:third_party/isl.BUILD",
    path = "/usr/local/Cellar/llvm/16.0.6",
)
